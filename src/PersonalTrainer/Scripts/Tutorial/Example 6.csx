// How to load a Gallery and play a simple slideshow.
...
// Note how we can have several things happening at once (slideshow and metronome) and
// by choosing which one we wait for, we can control the timing and sequnce of the 
// training session.
