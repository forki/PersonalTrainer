...
// Other useful RNG things we can do:
if (_.RNG.CoinFlipIsHeads())
    _.Trainer.Say("Coin flip is Heads.");
else
    _.Trainer.Say("Coin flip is Tails.");

if (_.RNG.IsPercentageChance(1))
    _.Trainer.Say("There is only a 1% chance to cum.");
else
    _.Trainer.Say("Ruin it please.");
